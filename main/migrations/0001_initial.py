    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'Admin'), (2, 'Teacher'), (3, 'Student'), (4, 'Parent')], default=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='MyModel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_task', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='main.task')),
            ],
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('WRONG ANSWER', 'Wa'), ('COMPILATION ERROR', 'Ce'), ('TIME LIMIT', 'Tl'), ('MEMORY LIMIT', 'Ml'), ('OK', 'Ok'), ('NOT CHECKED', 'Nc')], default='NOT CHECKED', max_length=17)),
                ('executable_path', models.CharField(blank=True, max_length=255)),
                ('lang', models.CharField(blank=True, max_length=255)),
                ('id_contest', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='main.contest')),
                ('id_task', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='main.task')),
                ('id_user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_report_sub', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='main.report_sub')),
            ],
            managers=[
        ...
        migrations.AddField(
            ...
            name='id_sub',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='main.submission'),
        ),
        migrations.CreateModel(
            name='legend',
            fields=[
