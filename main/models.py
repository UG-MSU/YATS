...
class submission(models.Model):
    ...
    id_contest = models.ForeignKey(
        'contest', on_delete=models.CASCADE, blank=True)
    timestamp = models.DateTimeField()
    status = models.CharField(choices=STATUS.choices, blank=True, max_length=17, default=STATUS.nc)
...
class report_sub(models.Model):
    ...
    id_sub = models.ForeignKey(
        'submission', on_delete=models.CASCADE, blank=True)
